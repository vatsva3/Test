...
function initChatbot() {
    ...
    const styles = `
        ...
        .chatbot-toggle {
            ...
            height: 60px;
            border-radius: 50%;
            background: linear-gradient(135deg, #3a6d8c 0%, #2d5468 100%);
            border: none;
            cursor: pointer;
            box-shadow: 0 4px 20px rgba(58, 109, 140, 0.4);
            display: flex;
            align-items: center;
        ...
        .chatbot-toggle:hover {
            ...
            box-shadow: 0 6px 30px rgba(58, 109, 140, 0.5);
        }
        ...
        .chatbot-input-area input:focus { border-color: #3a6d8c; }
        ...
        .chatbot-input-area button:hover { background: #2d5468; }
        ...
        .quick-reply:hover { background: #b8d4e3; }
